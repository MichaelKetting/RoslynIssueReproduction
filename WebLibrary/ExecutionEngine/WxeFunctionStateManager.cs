...
namespace Remotion.Web.ExecutionEngine
{
  ...
  public class WxeFunctionStateManager
  {
    ...
    public static WxeFunctionStateManager Current
    {
      get
      {
        var current = (WxeFunctionStateManager) HttpContext.Current.Session["WxeFunctionStateManager"];
        if (current == null)
        {
          current = CreateWxeFunctionStateManager();
          HttpContext.Current.Session["WxeFunctionStateManager"] = current;
        }
        return current;
      }
    }
