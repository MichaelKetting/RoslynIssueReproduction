...
namespace Remotion.Web.ExecutionEngine.Infrastructure
{
  ...
  public class WxeExecutor : IDisposable, IWxeExecutor
  {
    ...
    public WxeExecutor (HttpContext context, WxePage page, WxePageInfo wxePageInfo)
    {
    ...
    private string GetClosingScriptForExternalFunction (string functionToken, Control sender, bool returningPostback)
    {
      ...
      if (UsesEventTarget)
      {
        ...
        string eventTarget = postBackCollection[Page.postEventSourceID];
        string eventArgument = postBackCollection[Page.postEventArgumentID];
